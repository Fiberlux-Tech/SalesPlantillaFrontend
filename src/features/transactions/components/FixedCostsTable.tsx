                ...
                <table className="min-w-full text-sm divide-y divide-gray-200 table-fixed">
                    <thead className="bg-gray-50">
                        <tr>
                            ...
                            <th scope="col" className="w-24 px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">{UI_LABELS.TICKET}</th>
                            ...
                            <th scope="col" className="w-28 px-3 py-2 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">{UI_LABELS.DURACION}</th>
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                        {data.map((item, index) => (
                            <tr key={`fixed-cost-${item.id}-${index}`} className="hover:bg-gray-50">
                                ...
                                <td className="px-3 py-2 whitespace-nowrap text-gray-800 text-center">
                                    <EditableTableCell
                                ...
                                <td className="px-3 py-2 whitespace-nowrap text-red-600 font-medium text-right">{formatCurrency(item.total_pen)}</td>
