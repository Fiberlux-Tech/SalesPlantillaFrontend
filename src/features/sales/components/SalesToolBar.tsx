// src/features/sales/components/SalesToolBar.tsx

import React from 'react';
import DatePicker from '@/components/shared/DatePicker'; // Assumes DatePicker is/will be migrated
...
                {isDatePickerOpen && (
                    <DatePicker 
                        ...
                        onSelectDate={(date: Date) => { setSelectedDate(date); setIsDatePickerOpen(false); }} 
                        onClear={onClearDate} 
