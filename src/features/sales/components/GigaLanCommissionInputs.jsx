...
const SALE_TYPES = ['NEW', 'EXISTING'];

export function GigaLanCommissionInputs({ inputs, onInputChange }) {
    return (
        // Added bottom margin to separate from the next section (Detalle de Servicios)
        <div className="pt-4 mt-4 border-t border-gray-200 mb-6"> 
            <h4 className="font-semibold text-gray-800 mb-3 text-md">GIGALAN Commission Inputs</h4>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                {inputs.gigalan_sale_type === 'EXISTING' && (
                    <div>
